...
function BudgetItem({ budget }) {
  ...
  return (
    <div
      className="p-5 border rounded-lg bg-gradient-to-br from-white to-gray-100 shadow-lg hover:shadow-xl transform transition-transform hover:scale-105 cursor-pointer"
    >
