...
function ExpensesScreen({params}){
    ...
    {/* Dialog Box */}
    <div className="relative w-full max-w-md bg-[#1f1f1f] text-gray-300 p-6 rounded-lg shadow-lg z-10">
        <AlertDialogHeader>
            <AlertDialogTitle className="text-gray-100 text-lg font-bold">Are you absolutely sure?</AlertDialogTitle>
        ...
        <AlertDialogFooter className="flex flex-col space-y-4 mt-4">
            {/* Cancel Button */}
            <AlertDialogCancel className="flex items-center justify-center w-full px-4 py-2 bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600">
                Cancel
            </AlertDialogCancel>
            {/* Confirm Button */}
            <AlertDialogAction 
                onClick={() => deleteBudget()} 
                className="flex items-center justify-center w-full px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500"
            >
                Continue
            </AlertDialogAction>
        </AlertDialogFooter>
